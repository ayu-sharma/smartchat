...
function SmartInbox() {
    ...
    const askAiCopilot = async ()=>{
        ...
        const prompt = `Conversation:\n${selectedConversation?.messages.map((m)=>`${m.sender}: ${m.content}`).join('\n')}\n\nAgent, answer this: ${aiQuery}`;
        try {
            const suggestion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$ai$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAIResponse"])(prompt);
            setAiSuggestion(suggestion);
            setHasInternalContent(false); // You can add logic to detect internal content if needed
        } catch (e) {
            setAiSuggestion('Sorry, there was an error generating a response.');
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8eb0c8b8._.js.map